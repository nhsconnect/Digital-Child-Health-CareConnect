...
| Fetal Diagnosis         | CareConnect-Condition-1               | Optional                              | Fetal Diagnosis to be recorded as appropriately coded Condition                     |
...
| event | 1..1 | Fixed Value: "​problem-list-1 \| Problem List" |
...
### [CareConnect-Condition-1](https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Condition-1) (Diagnosis, Fetal Diagnosis)
...
| Element | Cardinality | Additional Guidance |
| --- | --- | --- |
| Condition.code | 1..1 | Condition.code SHALL use a value from https://fhir.nhs.uk/STU3/ValueSet/DCH-Problem-Condition-1 |
