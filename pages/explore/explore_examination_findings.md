...
| event | 1..1 | Fixed Value: "​examination-findings-1 \| ​Examination Findings" |
...
| Element | Cardinality | Additional Guidance |
| --- | --- | --- |
| Procedure.code | 1..1 | Procedure.code SHALL use a value from https://fhir.nhs.uk/STU3/ValueSet/DCH-ExaminationFindingProcedure-1 |
| Procedure.outcome | 1..1 | Procedure.outcome SHALL use a value from https://fhir.nhs.uk/STU3/ValueSet/DCH-ExaminationFindingOutcome-1 
