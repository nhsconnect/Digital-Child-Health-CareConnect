...
- [Event-MessageHeader-1](https://fhir.nhs.uk/STU3/StructureDefinition/Event-MessageHeader-1) - where the coding and display elements for the ‘event’ type are fixed to ‘​clinical-risk-factors-1 \| Clinical Risk Factors’
...
- [CareConnect-RiskAssessment-1](https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-RiskAssessment-1)
...
<div style="text-align:center; margin-bottom:20px" >
	<a href="images/explore/dch-clinicalriskfactors.png" target="_blank"><img src="images/explore/dch-clinicalriskfactors.png"></a><br/>
	Clinical Risk Factors <a href="images/explore/dch-clinicalriskfactors.png" target="_blank">(open in new TAB)</a>
</div>
...
|-------------------------------|-----------------------------------------------------------------------|----------------------------------------|-------------------------|
| Date/Time                     | CareConnect-RiskAssessment-1.occurrenceDateTime            | Mandatory                              |                         |
...
| Relevant Clinical Risk Factor | CareConnect-RiskAssessment-1.prediction.outcome            | Required                               | The free text field should be used if no coded text available, using code.text |
| Clinical Risk Assessment      | CareConnect-RiskAssessment-1.method                        | Required                               | The free text field for Clinical Risk Assessment should be entered using method.code.text |
| Risk Mitigation               | CareConnect-RiskAssessment-1.mitigation                    | Required                               |                         |
...
| event | 1..1 | Fixed Value: ‘​clinical-risk-factors-1 \| Clinical Risk Factors’ |
...
The CareConnect-RiskAssessment-1 resource included as part of the event message SHALL conform to the [CareConnect-RiskAssessment-1](https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-RiskAssessment-1) constrained FHIR profile and the additional population guidance as per the table below:

| Resource Cardinality | 1..14 |

| subject | 1..1 | This will reference the patient resource representing the subject of this event |
| context | 1..1 | This will reference the encounter resource representing the context of this event |
| performer | 1..1 | This will reference the practitioner resource representing the risk assessor |
| prediction | 0..1 | |
| prediction.outcome | 1..1 | prediction.outcome SHOULD take a value from  https://fhir.nhs.uk/STU3/ValueSet/DCH-ClinicalRiskFactorSnCT-1 | 


## Clinical Risk Factors Example ##

<script src="https://gist.github.com/IOPS-DEV/6c0eba119e74373c6e063a030d7709ef.js"></script>


## Profile Change Mappings for Clinical Risk Factors ##
...
| DCH-ClinicalRiskFactor-RiskAssessment-1 | CareConnect-RiskAssessment-1 |
